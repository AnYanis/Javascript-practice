// orderSummarycopy.js
// Purpose: Render the cart contents on the checkout page (copy version),
// allow quantity updates, deletes, and delivery option selection.
// Integrates with paymentSummarycopy.js to keep totals in sync.
import {
    cart,
    removeFromCart,
...
import { renderPaymentSummary } from './paymentSummarycopy.js';


export function renderAllOrderSummary() {
    // Update the small "(N items)" badge near page title
    ...
    // Render all items currently in the cart into the summary panel
    function rendercart() {
        let cartSummaryHTML = '';
    ...
    `;
        ...
        // Build the delivery options radio list for a product row
      ...
      `;
        ...
        // Delete button behavior: remove item, re-render, and refresh quantities
        ...
        // Switch a row into editing mode
        ...
        // Support pressing Enter to save a new quantity
        ...
        // Save a new quantity, validate input, and update UI
